...
DUMP_PATH - Path to the environment ready to import.
            ...
            files with records for fuel-devops DB, file with the list
            of empty volumes, volume binary files, memory state files,
            libvirt definitions for domains, networks, volumes, storage pool,
            network filters and snapshots.
