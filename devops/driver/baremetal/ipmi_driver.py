...
`           user(str)
    ...
    def get_capabilities():
        ...
        features = {'PowerManagement': ['status', 'on', 'off',
                    ...
                    'ChassisBootManagement': ['none', 'pxe', 'disk', 'cdrom', 'bios', 'floppy', 'safe', 'diag'],
    ...
    def exists(self):
        ...
        """
        return Node.check_remote_host(self.ipmi_user, self.ipmi_password, self.ipmi_host)
    ...
    def is_active(self):
        ...
        Returns: True if successful, False otherwise.
        """
        return (Node.power_status(self.ipmi_user, self.ipmi_password, self.ipmi_host) > 0)
    ...
    def start(self):
        ...
        Returns: True if successful, False otherwise.
        """
        return Node.power_on(self.ipmi_user, self.ipmi_password, self.ipmi_host)
    ...
    def destroy(self):
        ...
        Returns: True if successful, False otherwise.
        """
        return Node.power_off(self.ipmi_user, self.ipmi_password, self.ipmi_host)
    ...
    def reset(self):
        ...
        Returns: True if successful, False otherwise.
        """
        return Node.power_reset(self.ipmi_user, self.ipmi_password, self.ipmi_host)
