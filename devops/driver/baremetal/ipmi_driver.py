...
def run_ipmi(user, password, remote_host, cmd,
    ...
    Attributes:
        ...
        level(str)        -- the user privileges level. (default OPERATOR)
        ...
        remote_lan_interface(str) -- the lan interface.(default 'lanplus')
                values: lan, lanplus
        cmd(list)         -- impi command
        sol(bool)         -- sol ipmi interface. For future.
...
class Node(NodeBase):
    ...
    def is_active(self):
        ...
        Returns: True if successful, False otherwise.
        """
        return (0 == Node.power_status(self.ipmi_user, self.ipmi_password,
                                       self.ipmi_host))
    ...
    def start(self):
        ...
        Node.chassis_set_boot(self.ipmi_user, self.ipmi_password,
