...
class ParamedModelType(ModelBase):
    ...
    def __call__(cls, *args, **kwargs):
        ...
        if obj._type:
            # we store actual class name in _type attribute
            # so use it to load required class
            mod_name, cls_name = obj._type.split(':')
...
class ParamedModel(models.Model):
    ...
    def save(self, *args, **kwargs):
        # store current class to _type attribute
        self._type = self.__module__ + ':' + self.__class__.__name__
