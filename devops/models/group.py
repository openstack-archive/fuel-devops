...
#TODO: validate right params structure to avoid TypeError: 'forward' is an invalid keyword argument for this function
#                **params
            )
