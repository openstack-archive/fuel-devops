...
class Network(DriverModel):
    ...
    def add_filter_ref(self, interface):
        """Add reference to interface filter"""
        self.driver.network_filter_ref_add(self, interface)

    def remove_filter_ref(self, interface):
        """Remove reference to interface filter"""
        self.driver.network_filter_ref_remove(self, interface)
