...
class AddressPool(ParamedModel, BaseModel):
    ...
    def get_ip(ip_name):
        ...
        if ip_name in self.ip_reserved:
            return self.ip_reserved.get(ip_name)
        else:
            logger.debig("Reserved IP '{0}' not found in the "
