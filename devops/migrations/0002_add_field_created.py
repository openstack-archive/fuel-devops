...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('devops_environment', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 2, 6, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'devops.environment': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 6, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
