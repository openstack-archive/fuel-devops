...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'AddressPool', fields ['name', 'environment']
        ...
        db.create_table('devops_l2_network_device', (
            ...
            ('address_pool', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['devops.AddressPool'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        ...
        db.create_table('devops_network_pool', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.utcnow, auto_now_add=True, blank=True)),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['devops.AddressPool'], null=True)),
        ...
        db.add_column('devops_interface', 'l2_network_device',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['devops.L2NetworkDevice'], null=True),
                      keep_default=False)
        ...
        # Adding field 'Volume.group'
        db.add_column('devops_volume', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['devops.Group'], null=True),
                      keep_default=False)

        # Adding unique constraint on 'Volume', fields ['name', 'group']
        db.create_unique('devops_volume', ['name', 'group_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'AddressPool', fields ['name', 'environment']
    ...
    models = {
        ...
        'devops.addresspool': {
            'Meta': {'unique_together': "(('name', 'environment'),)", 'object_name': 'AddressPool', 'db_table': "'devops_address_pool'"},
        ...
        'devops.interface': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'l2_network_device': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['devops.L2NetworkDevice']", 'null': 'True'}),
        ...
        'devops.l2networkdevice': {
            'Meta': {'object_name': 'L2NetworkDevice', 'db_table': "'devops_l2_network_device'"},
            'address_pool': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['devops.AddressPool']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.utcnow', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        'devops.networkpool': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.utcnow', 'auto_now_add': 'True', 'blank': 'True'}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['devops.AddressPool']", 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        'devops.node': {
