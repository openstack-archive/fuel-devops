...
class DevopsClient(object):
    ...
    def __init__(self, env_name=None):
        self._env = Environment.get(name=env_name)
    ...
    def revert(self, name=None, flag=True):
        self._env.revert(name=name, flag=flag)

    def snapshot(self, name=None, description=None, force=False):
        self._env.snapshot(name=name, description=description, force=force)
    ...
    def add_slaves(self,
        ...
        try:
            ...
            raise DevopsError('Can\'t add slaves: {}'.format(error))
    ...
    def get_default_gw(self, l2_network_device_name=None):
        l2_net_dev = self._env.get_env_l2_network_device(
            l2_network_device_name)
    ...
    def get_node(self, **kwargs):
        return self._env.get_node(**kwargs)

    def get_nodes(self, **kwargs):
        return self._env.get_nodes(**kwargs)
