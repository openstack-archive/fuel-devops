...
class Shell(object):
    ...
    def do_list(self):
        self.print_envs_table([env.name for env in Environment.list_all()])
    ...
    def do_list_old(self):
        env_names_list = [env.name for env in self.get_old_environments()]
        self.print_envs_table(env_names_list)
