...
class Shell(object):
    ...
    def do_create(self):
        if self.params.config_file is not None:
            devops.settings.reload_settings(self.params.config_file)
    ...
    def get_params(self):
        ...
        third_disk_size.add_argument('--third-disk-size',
                                     ...
                                     help='Allocate the third disk for node '
                                          ...
                                          'allocated',
                                     default=50, type=int)
        config_file = argparse.ArgumentParser(add_help=False)
        config_file.add_argument('--config-file', dest='config_file',
