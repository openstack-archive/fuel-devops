...
class Shell(object):
    ...
    def do_cleanup_old(self):
        def convert_arg_to_timedelta(data):
        ...
        delta = convert_arg_to_timedelta(self.params.env_lifetime)
        ...
        if not self.params.force_cleanup:
            answer = self.query_yes_no(
                ...
                "all envs mentioned above will be erased. "
    ...
    def get_params(self):
        ...
        env_lifetime.add_argument(
            dest='env_lifetime',
            help='Erase envs older than given time interval. Use "5h", '
                 '"5d", "5w" syntax',
            default="", type=str)
