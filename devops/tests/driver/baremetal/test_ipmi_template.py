...
class TestIPMITemplate(TestCase):
    ...
    def setUp(self):
        ...
        def get_client(
            ...
            if nodename == 'slave-01':
                return self.ipmiclient1
            elif nodename == 'slave-02':
    ...
    def test_life_cycle(self):
        ...
        self.ipmiclient_mock.assert_any_call('user1', 'pass1',
                                                'ipmi-1.host.address.net',
                                                'OPERATOR',
                                                'lanplus',
                                                623,
                                                'slave-01')
        self.ipmiclient_mock.assert_any_call('user2', 'pass2',
                                             'ipmi-2.host.address.net',
                                             'OPERATOR',
                                             'lanplus',
                                             623,
                                             'slave-02')
