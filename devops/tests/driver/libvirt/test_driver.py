...
from devops.driver.libvirt.libvirt_driver import _LibvirtManagerBase
# from devops.models import Driver as DriverBase
...
class TestLibvirtManager(TestCase):
    ...
    def setUp(self):
        ...
        self.manager = _LibvirtManagerBase()
...
class TestLibvirtDriver(TestCase):
    ...
    def test_create(self):
        assert isinstance(self.d, Driver)
        ...
        assert self.d.use_hugepages is None
