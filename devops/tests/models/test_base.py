...
class TestParamedModel(TestCase):
    ...
    def test_related_qureset(self):
        ...
        assert g.node_set.get(name='n1')
        assert g.node_set.get(uuid='abc')
        assert g.node_set.get(role='fuel_slave', uuid='cde')
        assert g.node_set.get(hypervisor='kvm', name='n4')
