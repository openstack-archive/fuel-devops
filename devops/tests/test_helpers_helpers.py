...
class TestHelpersHelpers(unittest.TestCase):
    @mock.patch('devops.helpers.helpers.tcp_ping', return_value=False)
    def get_free_port(self, ping):
    ...
    @mock.patch('devops.helpers.helpers.tcp_ping_')
    ...
    @mock.patch('devops.helpers.helpers.SSHClient')
    ...
    def test_generate_mac(self, rand):
        rand.return_value = '\x01\x02\x03\x04\x05'
